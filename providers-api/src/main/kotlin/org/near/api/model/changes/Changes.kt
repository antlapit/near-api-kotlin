...
sealed interface StateChangeType {
    ...
    ) : org.near.api.model.account.Account(amount, locked, codeHash, storageUsage, storagePaidAt), StateChangeType {
        constructor(accountId: AccountId, account: org.near.api.model.account.Account) : this(
            accountId,
            account.amount,
            account.locked,
            account.codeHash,
