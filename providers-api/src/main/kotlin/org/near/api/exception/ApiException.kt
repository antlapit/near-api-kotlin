package org.near.api.exception
...
sealed class HandlerError(message: String?) : ApiException(message)
...
sealed class RequestValidationError(message: String?) : ApiException(message)
...
sealed class InternalError(message: String?) : ApiException(message)
