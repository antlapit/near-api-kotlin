...
class BlockRpcProviderTest {
    ...
    fun getBlock_whenLatest_thenCorrect() = runBlocking {
        // latest block
        val finalBlock = endpoint.getLatestBlock(org.near.api.providers.Finality.FINAL)
    ...
    fun getBlock_whenUnknownBlock_thenException() = runBlocking {
        ...
        assertTrue(e is org.near.api.providers.exception.UnknownBlockException)
    }
    ...
    fun getChunk_whenUnknownChunk_thenException() = runBlocking {
        ...
        assertTrue(e is org.near.api.providers.exception.UnknownChunkException)
    ...
    fun getChunk_whenInvalidShard_thenException() = runBlocking {
        ...
        assertTrue(e is org.near.api.providers.exception.InvalidShardIdException)
