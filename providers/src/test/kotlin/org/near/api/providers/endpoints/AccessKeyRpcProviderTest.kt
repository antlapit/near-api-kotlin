...
class AccessKeyRpcProviderTest {
    ...
    fun getAccessKeys_whenLatest_thenCorrect() = runBlocking {
        ...
        val finalKeys = endpoint.getAccessKeyList(accountId, org.near.api.providers.Finality.FINAL)
    ...
    fun getSingleAccessKey_whenLatest_thenCorrect() = runBlocking {
        ...
        val finalKey = endpoint.getAccessKey(accountId, publicKey, org.near.api.providers.Finality.FINAL)
