...
@ExperimentalKotest
class ApiExceptionFactoryTest : FunSpec({

    val mapper = ObjectMapperFactory.newInstance()
    val factory = ApiExceptionFactory(mapper)
    ...
    context("deserialize provider exception") {
        withData(
            ...
            TestData(
                ...
                """.trimIndent(),
                UnknownAccessKeyException(
                    PublicKey("5ZGzNvMNqV2g29YdMuYNfXi9LYa3mTqdxWXt9Nx4xF5tb"),
                    1,
                    "456"
                )
            ),
            ...
            TestData(
                ...
                """.trimIndent(),
                ApiException("HANDLER_ERROR", "dummy")
            ),
            TestData(
                """
                {
            ...
            TestData(
                ...
                """.trimIndent(),
                ApiException("REQUEST_VALIDATION_ERROR", "dummy")
            ),
            TestData(
                """
                {
            ...
            TestData(
                ...
                """.trimIndent(),
                ApiException("INTERNAL_ERROR", "dummy")
            ),
            TestData(
                """
                {
