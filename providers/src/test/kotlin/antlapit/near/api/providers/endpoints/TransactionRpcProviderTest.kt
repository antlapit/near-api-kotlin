...
internal class TransactionRpcProviderTest {
    ...
    fun getTransactionStatus_whenSuccessValue_thenCorrect() = runBlocking {
        val finalExecutionOutcome = endpoint.getTx("AB6pehcunRvvo2ErEWnWsAUX3xFsDTy6He2SgiwqJZQt", "namlebao19.testnet")
    ...
    fun getTransactionStatus_whenTxError_thenCorrect() = runBlocking {
        val finalExecutionOutcome = endpoint.getTx("yHHM8mGPVLToxwPGcMpNEm5TnjQkYPchQNf8NpoVZ8a", "07.oracle.flux-dev")
        assertEquals(FinalExecutionStatus.Failure(
            TxExecutionError.ActionError(index = 0, kind = ActionErrorKind.FunctionCallError(
